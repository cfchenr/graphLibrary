...
//        log.printf("%-30s%-20s%-60s","["+new Timestamp(new Date().getTime())+"]", string1, string2);
...
//        log.printf("%-30s%-20s%-60s%-10s","["+new Timestamp(new Date().getTime())+"]", string1, string2, string3);
...
//        log.printf("%-30s%-20s%-60s\n","["+new Timestamp(new Date().getTime())+"]", string1, string2);
...
//        log.printf("%-30s%-20s%-60s%-10s\n","["+new Timestamp(new Date().getTime())+"]", string1, string2, string3);
