...
public class Vertex {
    ...
    public Vertex (int vertex) {
        ...
        this.color = 0;
        this.visited = false;
        this.successorList = new ArrayList<Integer>();
        this.predecessorList = new ArrayList<Integer>();
    ...
    private boolean isSucessor (int k) {
        ...
        return this.successorList.contains(k);
    ...
    private boolean isPredecessor (int k) {
        ...
        return this.predecessorList.contains(k);
